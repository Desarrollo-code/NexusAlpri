...
import { InteractiveQuizEditor } from '@/components/resources/interactive-quiz-editor';
...
function EditQuizPageComponent({ params }: { params: { resourceId: string } }) {
    ...
    useEffect(() => {
        setPageTitle('Editor de Quiz Interactivo');
    }, [setPageTitle]);

    return <InteractiveQuizEditor folderId={params.resourceId} />;
}
