        ...
        <Card className="w-full max-w-md border-primary/20 shadow-lg shadow-primary/10">
            ...
            <CardContent>
                ...
                <div className="mt-4 text-center text-sm">
                    <Link href="/sign-in" className="font-semibold text-primary hover:underline">Volver a Inicio de Sesión</Link>
                </div>
            </CardContent>
        </Card>
      );
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="grid gap-4">
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <Link href="/sign-in" className="font-semibold text-primary hover:underline">Inicia sesión</Link>
          </div>
        </form>
      </CardContent>
    </Card>
