...
// Un componente SVG simple para nuestro monstruo amigable
const MonsterIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M45.57,26.51c-4.48,0-8.11,3.63-8.11,8.11v43.25c0,4.48,3.63,8.11,8.11,8.11h48.86c4.48,0,8.11-3.63,8.11-8.11V34.62c0-4.48-3.63-8.11-8.11-8.11H45.57Z" className="fill-background stroke-primary" strokeWidth="3"/>
        <path d="M37.46,54.14c-5.46-1.57-9.5-6.59-9.5-12.44,0-7.23,5.86-13.09,13.09-13.09h52.9c7.23,0,13.09,5.86,13.09,13.09,0,5.85-4.04,10.87-9.5,12.44" className="fill-primary" stroke="hsl(var(--primary))" strokeWidth="3" />
        ...
        <circle cx="60.32" cy="62.48" r="4.71" className="fill-primary" />
        <circle cx="79.68" cy="62.48" r="4.71" className="fill-primary" />
    </svg>
);
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background text-foreground p-6 text-center">
      <div className="flex items-center justify-center text-7xl md:text-9xl font-bold text-primary -ml-4 md:-ml-8">
        <span>4</span>
        <MonsterIcon className="h-28 w-28 md:h-40 md:w-40 mx-1 md:mx-4 text-primary" data-ai-hint="cute monster" />
        <span>4</span>
      </div>
