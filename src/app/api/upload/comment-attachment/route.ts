// src/app/api/upload/comment-attachment/route.ts
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const publicUrl = supabaseAdmin.storage.from('comment_attachments').getPublicUrl(finalPath).data.publicUrl;
    ...
    console.error('Error al preparar la subida de adjunto de comentario:', e);
