// src/app/api/upload/course-image/route.ts
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const publicUrl = supabaseAdmin.storage.from('course_images').getPublicUrl(finalPath).data.publicUrl;
    ...
    console.error('Error en /api/upload/course-image:', e);
