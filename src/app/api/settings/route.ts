...
const DEFAULT_DB_SETTINGS = {
  ...
  securityAuditImageUrl: null,
  tourMascotUrl: null,
  dashboardImageUrlAdmin: null,
  dashboardImageUrlInstructor: null,
  dashboardImageUrlStudent: null,
...
export async function POST(req: NextRequest) {
  try {
    ...
    const dataToSave = {
      ...
      faviconUrl: dataFromClient.faviconUrl,
      ...
      securityAuditImageUrl: dataFromClient.securityAuditImageUrl,
      tourMascotUrl: dataFromClient.tourMascotUrl,
      dashboardImageUrlAdmin: dataFromClient.dashboardImageUrlAdmin,
      dashboardImageUrlInstructor: dataFromClient.dashboardImageUrlInstructor,
      dashboardImageUrlStudent: dataFromClient.dashboardImageUrlStudent,
