...
            
            if (quiz) {
                // Estructura de las preguntas SÓLO para CREACIÓN (no incluye deleteMany)
                const questionsCreateData = (quiz.questions || []).map((q: AppQuestion, qIndex: number) => ({
                    text: q.text,
                    order: qIndex,
                    type: q.type,
                    template: q.template,
...
                                where: { resourceId: id },
                                
                                // === CORRECCIÓN APLICADA: SÓLO CREATE ===
                                create: {
                                    ...quizBasePayload,
                                    questions: { 
...
                                },
                                
                                // === CORRECCIÓN APLICADA: SÍ INCLUYE DELETE EN UPDATE ===
                                update: {
                                    ...quizBasePayload,
                                    questions: {
                                        deleteMany: {}, // **MANTENER AQUÍ:** Borra las preguntas viejas.
                                        create: questionsCreateData // Crea las preguntas nuevas.
                                    }
                                },
                            },
                        },
