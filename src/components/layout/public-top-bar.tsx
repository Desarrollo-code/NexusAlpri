    ...
    <header className={cn(
      ...
      <div className="hidden md:flex items-center justify-between px-4 lg:px-6 h-20">
        <Link href="/" className="flex items-center justify-center gap-3" prefetch={false}>
          <div className={cn("w-12 h-12 bg-gradient-to-br from-slate-800 to-amber-500 flex items-center justify-center shadow-inner flex-shrink-0 rounded-lg relative overflow-hidden", !settings?.logoUrl && "p-2")}>
      ...
      <div className="md:hidden flex items-center px-4 h-16 bg-gradient-to-r from-primary to-accent text-primary-foreground shadow-lg">
          <Link href="/" className="flex items-center justify-center gap-3" prefetch={false}>
            <div className={cn("w-10 h-10 bg-gradient-to-br from-slate-800 to-amber-500 flex items-center justify-center shadow-inner flex-shrink-0 rounded-lg relative overflow-hidden p-1")}>
