    ...
    return (
        <div className={cn(
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0">
                 {isMobile ? (
                    <Button onClick={toggleSidebar} variant="ghost" size="icon" className="h-8 w-8 text-primary-foreground/70 bg-white/10 hover:bg-white/20 hover:text-primary-foreground">
                        <PanelLeft className="h-5 w-5"/>
                        <span className="sr-only">Toggle Menu</span>
                    </Button>
                 ) : showBackButton ? (
                    <Button variant="ghost" size="icon" className="h-8 w-8 text-primary-foreground/70 bg-white/10 hover:bg-white/20 hover:text-primary-foreground" onClick={() => router.back()}>
            ...
            <div className="flex items-center gap-3">
                 ...
                 <Popover>
                    <PopoverTrigger asChild>
                        <Button variant="ghost" size="icon" className="relative text-primary-foreground/70 bg-white/10 hover:bg-white/20 hover:text-primary-foreground">
