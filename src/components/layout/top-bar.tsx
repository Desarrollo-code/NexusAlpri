...
export const TopBar = () => {
    ...
    return (
        <div className={cn(
            ...
            "bg-primary-gradient backdrop-blur-sm border-border"
        )}>
            {/* Left side */}
            ...
            <div className="flex items-center gap-3">
                 ...
                 <Popover>
                    <PopoverTrigger asChild>
                        <Button variant="ghost" size="icon" className="relative text-primary-foreground/70 hover:bg-white/20 hover:text-primary-foreground">
