...
export function TopBar() {
  ...
  return (
    <div className="h-16 bg-gradient-to-r from-primary/90 to-accent/90 backdrop-blur-lg border-b border-white/10 text-primary-foreground flex items-center justify-between px-4 lg:px-6 flex-shrink-0">
      ...
      <div className="flex items-center gap-2">
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="relative h-9 w-9 hover:bg-white/20" aria-label="Ver notificaciones">
        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                 <Button variant="ghost" className="flex items-center gap-2 h-10 px-2 hover:bg-white/20" aria-label="Abrir menú de usuario">
