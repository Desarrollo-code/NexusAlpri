...
export function MultipleChoiceTemplate({ 
    ...
    return (
        <div className="w-full flex flex-col items-center gap-4 md:gap-6">
            {/* Contenedor de Pregunta - Mejorado para evitar desbordamiento */}
            <Card className="w-full bg-background/80 backdrop-blur-sm p-4 md:p-6 text-center shadow-lg border-2">
                ...
                <h2 className="text-xl md:text-2xl font-bold font-headline leading-tight break-words" {...renderHtml(question.text)}></h2>
            </Card>

            {/* Imagen con límite de altura para no empujar los botones */}
            {question.imageUrl && (
            ...
            {/* Grid de Opciones - Corregido con grid-cols fijo para evitar el "encimado" */}
                    ...
                    return (
                        ...
                        >
                            <Button
                                variant="outline"
                                className={cn(
                                    // Cambio clave: de 'flex' a 'grid' con 3 columnas (Shape | Texto | Feedback)
                                    "w-full h-auto min-h-[70px] py-4 px-5 grid grid-cols-[auto_1fr_auto] items-center gap-4 text-left transition-all border-2",
