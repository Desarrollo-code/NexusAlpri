...
export default function AuthFormContainer({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-w-4xl mx-auto md:grid md:grid-cols-2">
            ...
            <div className="w-full p-6 sm:p-10 flex flex-col justify-center bg-slate-800">
                {children}
            </div>
        </div>
    );
