                         ...
                         <CardContent className="space-y-4">
                            ...
                            {course.imageUrl ? (
                                <div className="relative aspect-video rounded-md overflow-hidden border w-full">
                                    <Image src={course.imageUrl} alt="Imagen del Curso" width={600} height={400} className="w-full h-auto object-contain" onError={() => updateCourseField('imageUrl', null)} data-ai-hint="online course" />
