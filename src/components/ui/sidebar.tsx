    ...
    return (
      ...
      >
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute -right-4 top-8 z-50 h-8 w-8 rounded-full border border-sidebar-border bg-background/80 text-foreground backdrop-blur-sm transition-colors hover:bg-primary hover:text-primary-foreground"
