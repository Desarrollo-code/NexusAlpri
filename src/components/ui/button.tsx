...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 relative overflow-hidden shadow-md active:shadow-inner active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "border-primary/80 border bg-gradient-to-b from-primary/90 to-primary text-primary-foreground hover:from-primary hover:to-primary active:from-primary/90 active:to-primary/80",
        destructive:
