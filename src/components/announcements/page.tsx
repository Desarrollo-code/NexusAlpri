...
export default function AnnouncementsPage() {
  ...
  const handleDeleteAnnouncement = async () => {
    ...
    try {
      ...
      if (!response.ok && response.status !== 204) { // DELETE often returns 204
          ...
          <div className="flex flex-row flex-wrap items-center gap-2">
            <Dialog open={showCreateEditModal} onOpenChange={(isOpen) => {
              ...
              <DialogContent className="w-[95vw] max-w-lg rounded-lg max-h-[90vh] flex flex-col">
                ...
                <form onSubmit={handleSaveAnnouncement} id="create-update-form" className="flex-1 overflow-y-auto px-6 py-4 thin-scrollbar">
