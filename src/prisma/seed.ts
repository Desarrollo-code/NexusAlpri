...
const roadmapItemsToSeed = [
    ...
    { date: new Date('2024-08-20'), phase: RoadmapPhase.FASE_4, title: 'Gamificación y Reconocimiento', description: 'Lanzamiento del sistema de gamificación completo: se añaden los Certificados de Finalización con plantillas personalizables, los Mensajes de Motivación automáticos y las "Pausas Activas" interactivas en el calendario para ganar XP.', icon: 'Award', color: '#f59e0b' },
    { date: new Date('2024-11-15'), phase: RoadmapPhase.FASE_4, title: 'Lanzamiento Beta y Pruebas', description: 'La plataforma se lanza en una fase beta interna para recopilar feedback de los primeros usuarios, identificar errores y evaluar el rendimiento en un entorno real. Se establecen canales de comunicación para reportar incidencias.', icon: 'TestTube2', color: '#64748b'},
];
