...
const roadmapItemsToSeed = [
    { date: new Date('2024-05-15'), phase: RoadmapPhase.FASE_1, title: 'Concepción y Planificación Estratégica', description: 'Se identificó la necesidad de una plataforma de e-learning corporativa robusta y segura. Se definieron los roles de usuario (Administrador, Instructor, Estudiante) y se esbozó un Producto Mínimo Viable (MVP) con gestión de usuarios, creación de cursos y biblioteca de recursos.', icon: 'Lightbulb' },
    { date: new Date('2024-05-28'), phase: RoadmapPhase.FASE_1, title: 'Arquitectura y Desarrollo del Núcleo', description: 'Se inicializó el proyecto con Next.js y TypeScript. Se modeló la base de datos con Prisma y se crearon los endpoints API para las operaciones CRUD básicas. Se construyó la interfaz de usuario base, incluyendo layouts y páginas de gestión iniciales.', icon: 'Code' },
    { date: new Date('2024-06-10'), phase: RoadmapPhase.FASE_2, title: 'Expansión de Módulos Centrales', description: 'Introducción de los módulos de Anuncios y Calendario. Se implementa la capacidad de subir archivos a la Biblioteca de Recursos y crear eventos, sentando las bases para una comunicación y gestión de contenido más ricas.', icon: 'Layers3' },
    { date: new Date('2024-07-05'), phase: RoadmapPhase.FASE_3, title: 'Interactividad y Colaboración', description: 'Se habilita la sección de comentarios dentro de cada curso y se introduce un sistema de reacciones en los anuncios para fomentar la participación. Se rediseña la gestión de usuarios, que pasa a llamarse "Control Central", unificando la administración de colaboradores y procesos organizacionales con una interfaz de arrastrar y soltar.', icon: 'Users' },
    { date: new Date('2024-08-20'), phase: RoadmapPhase.FASE_4, title: 'Gamificación y Reconocimiento', description: 'Lanzamiento del sistema de gamificación completo: se añaden los Certificados de Finalización con plantillas personalizables, los Mensajes de Motivación automáticos y las "Pausas Activas" interactivas en el calendario para ganar XP.', icon: 'Award' },
    { date: new Date('2024-11-15'), phase: RoadmapPhase.FASE_4, title: 'Lanzamiento Beta y Pruebas', description: 'La plataforma se lanza en una fase beta interna para recopilar feedback de los primeros usuarios, identificar errores y evaluar el rendimiento en un entorno real. Se establecen canales de comunicación para reportar incidencias.', icon: 'TestTube2'},
];
