...
-- AddForeignKey
ALTER TABLE `CourseProgress` ADD CONSTRAINT `CourseProgress_userId_courseId_fkey` FOREIGN KEY (`userId`, `courseId`) REFERENCES `Enrollment`(`userId`, `courseId`) ON DELETE CASCADE ON UPDATE CASCADE;
