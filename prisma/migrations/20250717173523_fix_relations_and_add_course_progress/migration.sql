...
CREATE TABLE `_CourseProgressToLesson` (
    ...
    UNIQUE INDEX `_CourseProgressToLesson_AB_unique`(`A`, `B`),
    INDEX `_CourseProgressToLesson_B_index`(`B`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `_CourseProgressToLesson` ADD CONSTRAINT `_CourseProgressToLesson_B_fkey` FOREIGN KEY (`B`) REFERENCES `Lesson`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
