...
CREATE TABLE `LessonTemplate` (
    ...
    `baseLessonId` VARCHAR(191) NULL,

    UNIQUE INDEX `LessonTemplate_baseLessonId_key`(`baseLessonId`),
...
CREATE TABLE `PlatformSettings` (
    ...
    `resourceCategories` TEXT NULL DEFAULT 'Recursos Humanos,TI y Seguridad,Marketing,Ventas,Legal,Operaciones,Finanzas,Formación Interna,Documentación de Producto,General',
