...
CREATE TABLE `ContentBlock` (
    ...
    `templateBlockId` VARCHAR(191) NULL,

    UNIQUE INDEX `ContentBlock_templateBlockId_key`(`templateBlockId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PlatformSettings` (
    ...
    `updatedAt` DATETIME(3) NOT NULL,
    `primaryColor` VARCHAR(191) NULL DEFAULT '#5E5CE6',
    `secondaryColor` VARCHAR(191) NULL DEFAULT '#00C2D8',
    `accentColor` VARCHAR(191) NULL DEFAULT '#FFD60A',
    `backgroundColorLight` VARCHAR(191) NULL DEFAULT '#F7F7F8',
    `primaryColorDark` VARCHAR(191) NULL DEFAULT '#BF5AF2',
    `backgroundColorDark` VARCHAR(191) NULL DEFAULT '#1C1C1E',
...
CREATE TABLE `LearningPathCourse` (
    ...
    UNIQUE INDEX `LearningPathCourse_pathId_courseId_key`(`pathId`, `courseId`),
    UNIQUE INDEX `LearningPathCourse_pathId_order_key`(`pathId`, `order`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `LearningPathEnrollment` (
    ...
    UNIQUE INDEX `LearningPathEnrollment_userId_pathId_key`(`userId`, `pathId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `ContentBlock` ADD CONSTRAINT `ContentBlock_templateBlockId_fkey` FOREIGN KEY (`templateBlockId`) REFERENCES `TemplateBlock`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
