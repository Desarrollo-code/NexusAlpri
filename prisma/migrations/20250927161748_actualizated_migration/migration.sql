...
ALTER TYPE "AchievementSlug" ADD VALUE 'FIRST_NOTE';
ALTER TYPE "AchievementSlug" ADD VALUE 'FIRST_REACTION';
ALTER TYPE "AchievementSlug" ADD VALUE 'FIRST_RESOURCE_DOWNLOAD';
ALTER TYPE "AchievementSlug" ADD VALUE 'FIRST_COURSE_PUBLISHED';
ALTER TYPE "AchievementSlug" ADD VALUE 'TEN_COURSES_COMPLETED';
ALTER TYPE "AchievementSlug" ADD VALUE 'TWENTY_COURSES_COMPLETED';
ALTER TYPE "AchievementSlug" ADD VALUE 'HIGH_PERFORMER';
ALTER TYPE "AchievementSlug" ADD VALUE 'LEVEL_5_REACHED';
ALTER TYPE "AchievementSlug" ADD VALUE 'LEVEL_10_REACHED';
ALTER TYPE "AchievementSlug" ADD VALUE 'LEVEL_20_REACHED';

-- AlterEnum
BEGIN;
CREATE TYPE "FormFieldType_new" AS ENUM ('SHORT_TEXT', 'PARAGRAPH', 'SINGLE_CHOICE', 'MULTIPLE_CHOICE');
